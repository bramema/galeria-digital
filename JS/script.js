...
const SUPABASE_KEY = 'sb_publishable_r8YxKSCQo7L-LFIu-ck6lw_baWB5CY4'; // Asegúrate de colocar aquí la clave anon public

// 2. Inicialización del cliente (se usa la variable global que provee el script de CDN)
...
// C. Guardar registro en la base de datos (con nombres de columna corregidos)
const { error: dbError } = await supabaseClient
.from('fotos1') // Nombre exacto de tu tabla
.insert([
{ 
image_url: photoUrl, 
author: author, 
